const keyapi = 'f6c2e375fff61af5ef7635faea1153c5'
...
/* Minha chave da API f6c2e375fff61af5ef7635faea1153c5*/
async function capturarDadoAPI(){
    let Api = 'https://api.openweathermap.org/data/2.5/weather?q=${petrolina}&appid=${keyapi}'
